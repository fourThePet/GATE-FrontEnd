...
const SvgWhiteCalender = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <g clipPath="url(#white__calender_svg__a)">
      <path
        fill="#fff"
    ...
    <defs>
      <clipPath id="white__calender_svg__a">
        <path fill="#fff" d="M0 0h16v16H0z" />
      </clipPath>
    </defs>
  </svg>
);
export default SvgWhiteCalender;
