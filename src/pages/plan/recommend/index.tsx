...
import { bottomButtonStyle, contentWrapper, infoWrapper, listWrapper, mapWrapper, PlanRegisterWrapper, recommendText, wrapper } from "./index.styles";
                ...
                <div css={listWrapper}>
                    ...
                    <div css={PlanRegisterWrapper}>
                        ...
                        <div css={recommendText}>
                            ...
                            <Text type="Label21" color={colors.color.Gray1}>추천받은 일정을 내 일정으로 담으면 언제든 확인하고 편집할 수 있어요!</Text>
                        </div>
                    </div>
                    <div css={bottomButtonStyle}>
                        <MainPinkButton title="내 일정으로 담기" width="30%" height="36px"/>
                    </div>
                </div>
            </div>
        </div>
